...
CREATE TABLE tasks (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, /* id SERIAL PRIMARY KEY - short cut of BIGNT UNSIGNED AUTO_INCREMENT*/
    user_id INT UNSIGNED NOT NULL, /* las calve foranea deve coincidir exactamente al tipo de datos de la clave primaria*/
    tittle VARCHAR(255) NOT NULL,
    description VARCHAR(512) NOT NULL,
    completed BOOLEAN NOT NULL, /* ENUM("COMPLETED", "NOT COMPLETED") */
...
use 'Name'; -- afecta o modifica la tabla

create table users(id int, name varchar(255), email varchar(255), password varchar(255)); 
-- Para cadenas cortas Varchar(255), el numero es igual al numero de caracteres

describe users; muestra las filas y columnas de la tabla especifica


source 'todos.sql'; nombre de fichero 

TIPOS DE datos

'BIGNT' UNSIGNED AUTO_INCREMENT or SERIAL--  -2^63-1 equivalente a 64 bits con signo, y sin signo es 2^64-1
